...
) -> Optional[Union[List["DefaultError"], List[List["StripePlan"]]]]:
    if response.status_code == HTTPStatus.OK:
        ...
        for response_200_item_data in _response_200:
            ...
            for response_200_item_item_data in _response_200_item:
                response_200_item_item = StripePlan.from_dict(response_200_item_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[List["DefaultError"], List[List["StripePlan"]]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[List['DefaultError'], List[List['StripePlan']]]
    """
