...
class ChunkMetadataWithFileData:
    ...
    Attributes:
        ...
        weight (float):
        author (Union['UserDTO', None, Unset]):
    ...
    updated_at: datetime.datetime
    weight: float
    author: Union["UserDTO", None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        author: Union[Dict[str, Any], None, Unset]
        if isinstance(self.author, Unset):
            author = UNSET
        elif isinstance(self.author, UserDTO):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_author(data: object) -> Union["UserDTO", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                author_type_1 = UserDTO.from_dict(data)

                return author_type_1
            except:  # noqa: E722
                pass
