...
class ClientDatasetConfiguration:
    ...
    Attributes:
        ...
        show_github_stars (Union[None, Unset, bool]):
    ...
    show_github_stars: Union[None, Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        show_github_stars: Union[None, Unset, bool]
        if isinstance(self.show_github_stars, Unset):
            show_github_stars = UNSET
        else:
            show_github_stars = self.show_github_stars
        ...
        if show_github_stars is not UNSET:
            field_dict["SHOW_GITHUB_STARS"] = show_github_stars
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_show_github_stars(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        show_github_stars = _parse_show_github_stars(d.pop("SHOW_GITHUB_STARS", UNSET))
        ...
        client_dataset_configuration = cls(
            ...
            show_github_stars=show_github_stars,
