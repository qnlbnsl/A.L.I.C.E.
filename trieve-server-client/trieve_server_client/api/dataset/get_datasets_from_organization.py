...
) -> Optional[Union[List["DatasetAndUsage"], List["DefaultError"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[List["DatasetAndUsage"], List["DefaultError"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[List['DatasetAndUsage'], List['DefaultError']]
    """
